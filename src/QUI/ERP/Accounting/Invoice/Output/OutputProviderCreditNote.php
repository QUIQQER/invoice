...
class OutputProviderCreditNote extends OutputProviderInvoice
{
    ...
    public static function getMailSubject($entityId)
    {
        ...
        return QUI::getLocale()->get('quiqqer/invoice', 'invoice.credit_note.send.mail.subject', [
    ...
    public static function getMailBody($entityId)
    {
        ...
        return QUI::getLocale()->get('quiqqer/invoice', 'invoice.credit_note.send.mail.message', [
            'invoiceId' => $Invoice->getId(),
            'user'      => $user,
